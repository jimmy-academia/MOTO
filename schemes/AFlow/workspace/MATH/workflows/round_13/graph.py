...
import workspace.MATH.workflows.round_13.prompt as prompt_custom
...
class Workflow:
    ...
    async def __call__(self, problem: str):
        ...
        ensemble_solution = self.sc_ensemble(solutions=solutions, problem=problem)
        
        return ensemble_solution['response'], self.llm.get_usage_summary()["total_cost"]
